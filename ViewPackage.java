...
public class ViewPackage extends JFrame implements ActionListener{
    ...
    ViewPackage(String username){
        ...
        labelemail.setBounds(220,290,150,25);
        add(labelemail);
        ...
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("icons/Copy of bookedDetails.jpg"));
