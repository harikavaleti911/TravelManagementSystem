...
public class DeleteDetails extends JFrame implements ActionListener{
    ...
    DeleteDetails(String username){
        ...
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("icons/Copy of viewall.jpg"));
        ...
        ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("icons/Copy of viewall.jpg"));
