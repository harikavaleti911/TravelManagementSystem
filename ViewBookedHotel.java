...
public class ViewBookedHotel extends JFrame implements ActionListener{
    ...
    ViewBookedHotel(String username){
        ...
        lblnodays.setBounds(30,170,150,25);
        add(lblnodays);
        
        JLabel labelnodays=new JLabel();
        labelnodays.setBounds(220,170,150,25);
        add(labelnodays);
        ...
        lblemail.setBounds(30,410,150,25);
        add(lblemail);
        
        JLabel labelemail=new JLabel();
        labelemail.setBounds(220,410,150,25);
        add(labelemail);
        ...
        try{
            ...
            while(rs.next()){
                ...
                labelnodays.setText(rs.getString("days"));
                labelroom.setText(rs.getString("acroom"));
                labelfood.setText(rs.getString("foodInc"));
