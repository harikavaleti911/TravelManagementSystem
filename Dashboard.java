...
public class Dashboard extends JFrame implements ActionListener{
    ...
    JButton addPersonDetails,viewPersonDetails,updatePersonDetails,deletePersonalDetails,checkPackages,bookPackages,viewPackages,viewHotels,bookHotel,viewBookedHotel,destinations,payments,notepad,about,calculators;
    String username;
    Dashboard(String username){
        ...
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("icons/Copy of dashboard.png"));
        ...
        ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("icons/Copy of home.jpg"));
